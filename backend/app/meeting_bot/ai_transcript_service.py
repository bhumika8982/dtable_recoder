...
_SYSTEM = (
    "You are an expert transcript proofreader for bilingual English+Hindi "
    "speech-recognition output. Fix recognition errors using context. Fix ALL of:\n"
    ...
    "- NEVER translate. Do NOT turn English into Hindi or Hindi into English.\n"
    ...
    "wording and the exact mix of languages the speaker used.\n"
